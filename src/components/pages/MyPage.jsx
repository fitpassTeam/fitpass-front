import { FaUserCircle, FaPhone, FaBirthdayCake, FaMapMarkerAlt, FaVenusMars, FaCrown, FaEdit, FaTrash } from 'react-icons/fa';
...
function MyPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto py-12 px-2 flex flex-col gap-8">
        ...
        <div className="bg-gradient-to-r from-green-200 via-blue-100 to-purple-100 rounded-2xl shadow-lg flex flex-col sm:flex-row items-center gap-6 p-8">
          <div className="flex-1 flex flex-col items-center sm:items-start">
            ...
            <div className="flex gap-4">
              ...
              <button
                className="px-6 py-3 bg-blue-500 hover:bg-blue-600 text-white rounded-full font-bold shadow transition-all"
                onClick={() => navigate('/membership-management')}
              >
                이용권 관리
              </button>
              <button
                className="px-6 py-3 bg-purple-500 hover:bg-purple-600 text-white rounded-full font-bold shadow transition-all"
      ...
      {/* ADMIN 권한: 전용 액션 카드 */}
      {user.userRole === 'ADMIN' && (
        <div className="bg-gradient-to-r from-gray-100 to-gray-200 rounded-2xl shadow-lg flex flex-col items-center gap-6 p-8 mt-4">
          ...
          <div className="flex gap-4">
            ...
            <button
              className="px-6 py-3 bg-green-500 hover:bg-green-600 text-white rounded-full font-bold shadow transition-all"
              onClick={handleOwnerRequests}
            >
              오너 권한 대기 목록
            </button>
            <button
              className="px-6 py-3 bg-purple-500 hover:bg-purple-600 text-white rounded-full font-bold shadow transition-all"
              onClick={handleGymRequests}
            >
              체육관 승인 대기 목록
            </button>
          </div>
      ...
      {errorMsg && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30">
          <div className="bg-white rounded-2xl shadow-2xl max-w-xs w-full p-8 flex flex-col items-center animate-fadeIn">
      ...
      {chargeModal.open && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30">
          <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-8 flex flex-col items-center animate-fadeIn">
      ...
      {ownerModal.open && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30">
          <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full p-8 flex flex-col animate-fadeIn max-h-[80vh] overflow-y-auto">
